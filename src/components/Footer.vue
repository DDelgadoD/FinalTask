  ...
  <footer class="footer-main bg-dark">
      ...
      <div class="row address-main">
        <div class="col-lg-4 col-sm-12 col-xs-12">
          <div class="address-box clearfix">
            <div class="add-icon">
              <img src="../assets/footer/address.png" alt="" />
            </div>
        ...
        <div class="col-lg-4 col-sm-12 col-xs-12">
          <div class="address-box clearfix">
            <div class="add-icon">
              <img src="../assets/footer/phone-chibi.png" alt="" />
            </div>
            <div class="add-content">
              <h5>Phone</h5>
              <p> +(91) 000000000 <br />
        ...
        <div class="col-lg-4 col-sm-12 col-xs-12">
          <div class="address-box clearfix">
            <div class="add-icon">
              <img src="../assets/footer/email-chibi.png" alt="" />
            </div>
            <div class="add-content">
              <h5>Email</h5>
              <p> <a href="mailto:" style="text-decoration:none">david.delgado82@gmail.com</a> </p>
            </div>
          </div>
        </div>
      </div>
    ...
    <footer class="bg-dark text-center text-white">
      ...
      <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
        David Delgado International Holdings Group Company Ltd. © 2023 All Rights Reserved.
      </div>
      <!-- Copyright -->
    </footer>
  </footer>
